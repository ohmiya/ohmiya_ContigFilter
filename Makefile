SERVICE = ohmiyajohn_contigfilter
SERVICE_CAPS = ohmiyajohn_ContigFilter
SPEC_FILE = ohmiyajohn_ContigFilter.spec
URL = https://kbase.us/services/ohmiyajohn_contigfilter
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
